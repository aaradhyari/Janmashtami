...
/**
 * Riddles tab of the admin panel: browse all 25 पहेलियाँ,
        ...
        <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
          {!isLiveSelected ? (
            <button
              ...
              className="rounded-xl bg-gradient-to-r from-[#2563EB] to-[#8B5CF6] px-4 py-3.5 text-sm font-bold tracking-wide transition hover:brightness-110 active:scale-[0.99] sm:col-span-2"
            >
